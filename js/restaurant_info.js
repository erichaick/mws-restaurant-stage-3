 ...
 */
generateBreadcrumb = (restaurant = self.restaurant) => {
...
/**
 * clikc to toggle to like/unlike the current restaurant
 *
 * toggleFavourite click event to PUT to update the status of like
*/
//

toggleFavourite = () => {
  self.restaurant.is_favorite = !self.bool_favouriteImage;
  generateFavouriteimage(self.restaurant.is_favorite);
  ...
  fetch(url, fetchOptions).then(DBHelper.updateRestaurants);
};

generateFavouriteimage = (isFavorite) => {
  var favouriteImageEl = document.getElementById('myFavouriteImg');
  favouriteImageEl.setAttribute('src', isFavorite
    ? "img/favourite.png"
    : "img/unfavourite.png");
  self.bool_favouriteImage = isFavorite;
}
 ...
 */(() => {
  fetchRestaurantFromURL().then((restaurant) => {
    ...
    generateFavouriteimage(restaurant.is_favorite);
